...
import com.beicai.caseclass.IPRule
import com.beicai.common.LogConstants
...
object LogAnalysis {
      ...
      if (dataArray.length == 2) {
        ...
        if (data.length == 2) {
          ...
          if (behavior.equals("bData")) {
            ...
            logMap.put(LogConstants.LOG_COLUMNS_NAME_BEHAVIOR_FLAG, "pDtata")
          }
          //取出base64转码的字符串
  ...
  /**
    * 解析单条日志方法
    *
    * @param logText 106.61.111.250|0.000|-|24/Apr/2018:03:14:21 +0800|GET
    *                /?bData=eyJrdGluZ1Rva2VuIjoiQzVRUzZUZUNnb3NZcURkOGVmcnZaZEZoVkpWWmZtNXNLdktzR3VxQVp5MFpGN242RFhpZ
    *                XB4XC8wM0prdm1zN2RkeDk2Y2s5aG05N1FKM0h0SmZxOHpRPT0iLCJiZWhhdmlvcktleSI6IkRGU0o0MDAiLCJiZWhhdmlvckRhdGE
    *                iOnsiem9uZ0tleSI6IkZNNzAyIiwicHJvZ3JhbUlkIjoiMzEwMTMxIiwiYWxidW1JZCI6IjE2MjQ5IiwiYW5jaG9ySWQiOiIxMTUw
    *                NSIsInBsYXlUaW1lIjowLCJvbi1vZmYiOmZhbHNlfX0= HTTP/1.1|
    *                200|5|"Dalvik/2.1.0 (Linux; U; Android 7.0; WAS-AL00 Build/HUAWEIWAS-AL00)" sendfileon
    * @param ipRules
    */
